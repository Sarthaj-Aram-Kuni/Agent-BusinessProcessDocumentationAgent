...
function typeStyles(type: string) {
  switch (type) {
    case "manual":
      return {
        bg: "bg-orange-900/30 text-orange-400 border-orange-800/40",
        dot: "bg-orange-400",
      };
    case "automated":
      return {
        bg: "bg-teal-900/30 text-teal-400 border-teal-800/40",
        dot: "bg-teal-400",
      };
    case "decision":
      return {
        bg: "bg-purple-900/30 text-purple-400 border-purple-800/40",
        dot: "bg-purple-400",
      };
    default:
      return {
      ...
      <div className="space-y-2">
        {steps.map((step, index) => {
          ...
          return (
            ...
            >
              {/* Step number */}
              <span className="flex-shrink-0 w-7 h-7 flex items-center justify-center bg-gray-800 text-gray-400 text-xs font-mono rounded-full mt-0.5">
                {step.id || index + 1}
              </span>
