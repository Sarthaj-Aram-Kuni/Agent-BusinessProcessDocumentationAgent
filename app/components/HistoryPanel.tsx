...
export default function HistoryPanel({ onLoad, refreshKey }: HistoryPanelProps) {
  ...
  return (
    <div className="mt-4 bg-gray-900 border border-gray-800 rounded-lg overflow-hidden">
      ...
      <button
        onClick={() => setOpen((o) => !o)}
        className="w-full flex items-center justify-between px-4 py-3 hover:bg-gray-800/40 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-inset"
      >
      ...
      {open && (
        <div className="border-t border-gray-800">
          {history.map((entry, i) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 text-left hover:bg-gray-800/50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-inset ${
          ...
          <div className="px-4 py-2.5 border-t border-gray-800/60 flex justify-end">
            <button
              onClick={handleClear}
              className="text-xs text-gray-600 hover:text-red-400 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded"
            >
              Clear history
            </button>
          </div>
