      ...
      <div className="p-6 bg-gray-900 border border-gray-800 rounded-lg">
        ...
        <div className="space-y-2">
          {bottlenecks?.map((bottleneck, index) => (
            <div key={index} className="bg-gray-950/40 rounded-lg overflow-hidden transition-transform duration-150 hover:scale-[1.01]">
              {/* Header — clickable */}
              <button
                onClick={() =>
                ...
                className="w-full flex items-center justify-between p-3 text-left hover:bg-gray-950/60 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-inset"
              >
