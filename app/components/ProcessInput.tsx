        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {EXAMPLES.map((example) => (
            <button
              ...
              disabled={loading}
              className="px-2.5 py-1 text-xs bg-gray-800/80 hover:bg-gray-700 text-gray-400 hover:text-gray-200 rounded-md transition-all disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
            >
              {example.label}
            </button>
          ))}
      ...
      <div className="flex items-center justify-between mt-3">
        <div className="flex items-center gap-4">
          ...
          {input.length > 0 && (
            <button
              onClick={() => setInput("")}
              disabled={loading}
              className="text-xs text-gray-600 hover:text-gray-400 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded"
            >
              Clear
            </button>
          )}
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-6 py-2.5 bg-teal-600 hover:bg-teal-500 disabled:bg-gray-800 disabled:text-gray-600 disabled:cursor-not-allowed rounded-lg font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-950"
          >
            {loading ? (
