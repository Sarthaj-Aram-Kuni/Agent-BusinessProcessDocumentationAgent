...
export default function Home() {
  ...
  // Scroll to results whenever a new analysis lands
  useEffect(() => {
    if (result) {
  ...
  return (
    <main className="min-h-screen bg-gray-950">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          <div className="flex flex-wrap items-start justify-between gap-y-4">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/compare"
                className="text-sm text-gray-500 hover:text-gray-300 transition-colors px-3 py-1.5 rounded-lg hover:bg-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
              >
                Compare Processes →
              </Link>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
            ...
            <div className="flex items-start justify-between">
              ...
              {lastInput && (
                <button
                  onClick={handleRetry}
                  disabled={loading}
                  className="shrink-0 ml-4 px-3 py-1.5 text-sm bg-red-900/40 hover:bg-red-900/60 text-red-300 border border-red-800/40 rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500"
                >
                  Retry
                </button>
              )}
        ...
        {/* Results */}
        {result && (
          <div ref={resultsRef} className="mt-8 space-y-6 stagger-children">
            {/* Export buttons */}
